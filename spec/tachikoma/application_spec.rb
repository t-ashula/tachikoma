...
YAML
  ...
  context 'if strategy is `gom`' do
    ...
    it 'should be called `gom` method' do
      expect_any_instance_of(Tachikoma::Application).to receive(:gom)
      Tachikoma::Application.run 'gom'
    end
  end
